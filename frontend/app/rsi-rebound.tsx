...
export default function RsiReboundScreen() {
  ...
  const load = useCallback(async () => {
    try {
      const p = await rsiReboundApi.portfolio();
      setPortfolio(p);
    } catch {
      // ignore
    } finally {
  ...
  const onDeposit = async () => {
    ...
    setDepositing(true);
    try {
      await rsiReboundApi.deposit(amount);
  ...
  const onWithdraw = async () => {
    ...
    setWithdrawing(true);
    try {
      await rsiReboundApi.withdraw(amount);
  ...
  const renderPosition = (p: RsiReboundPosition, closed: boolean) => {
        ...
        <View style={styles.posTop}>
          ...
          {p.rsi_at_entry !== undefined && (
            <View style={styles.setupBadge}>
              <Text style={styles.setupBadgeText}>RSI {p.rsi_at_entry.toFixed(0)} → entrata</Text>
            </View>
          )}
        </View>
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>RSI Rebound</Text>
        <View style={{ width: 26 }} />
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalSubtitle}>
              Sposta fondi dal portafoglio principale a RSI Rebound.
            </Text>
            <TextInput
      ...
      <Modal visible={withdrawVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalSubtitle}>
              Sposta fondi da RSI Rebound al portafoglio principale.
            </Text>
            <TextInput
              style={styles.modalInput}
              placeholder="Importo in USDT"
      ...
      <Modal visible={resetVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <Text style={styles.modalTitle}>Reset RSI Rebound</Text>
            <Text style={styles.modalSubtitle}>
