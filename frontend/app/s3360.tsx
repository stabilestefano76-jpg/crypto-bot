...
import { s3360Api, S3360Portfolio, S3360Position } from "@/src/api";
...
export default function S3360Screen() {
  ...
  const { panHandlers, index, total } = useSwipeNavigation("/s3360");
  const [portfolio, setPortfolio] = useState<S3360Portfolio | null>(null);
  ...
  const load = useCallback(async () => {
    try {
      const p = await s3360Api.portfolio();
      setPortfolio(p);
    } catch {
      // ignore
    } finally {
  ...
  const onWithdraw = async () => {
    ...
    setWithdrawing(true);
    try {
      await s3360Api.withdraw(amount);
  ...
  const renderPosition = (p: S3360Position, closed: boolean) => {
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]} {...panHandlers}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>33/60</Text>
        <View style={{ width: 26 }} />
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalSubtitle}>
              Sposta fondi dal portafoglio principale a 33/60.
            </Text>
            <TextInput
      ...
      <Modal visible={withdrawVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalSubtitle}>
              Sposta fondi da 33/60 al portafoglio principale.
            </Text>
            <TextInput
              style={styles.modalInput}
              placeholder="Importo in USDT"
      ...
      <Modal visible={resetVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <Text style={styles.modalTitle}>Reset 33/60</Text>
            <Text style={styles.modalSubtitle}>
